...
class MyAgent(ACTR):
    ...
    DM.add('customer:very_tall_male condiment:mayonnaise')
    DM.add('customer:very_tall_female condiment:chipotle')   
...
##        DM.add('customer:mary condiment:ketchup')
    ...
    def ham(focus='task:sandwich object:ham', something='state:done'):
        ...
        focus.set('customer:very_tall_male object:condiment') ###
        focus.set('customer:very_tall_female object:condiment')
